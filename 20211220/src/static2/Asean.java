...
public class Asean {
	...
	// 공용 발표점수인 presentationScore를 static으로 만들어주세요.     이 점수는 19점입니다.
	...
	public void showAseanInfo() {
		System.out.println("출석점수 : " + this.check + ", 중간고사 : " + this.midTerm + 
				           ", 기말고사 : " + this.finalTerm + ", 발표점수 : " + presentationScore);
	}
