...
public class ScannerQ1P93 {
	...
	public static void main(String[] args) {
		...
		System.out.println("원화 " + won + "원을 미국 달러로 환전시");
		// won/rate를 Math.round()로 감싼 다음, 10^n승을 곱하고 10.0^n승으로 나눠주면
		// n승에 해당하는 자리수만큼 소수점 자리까찌만 나옵니다.
		System.out.println(Math.round(won / rate*1000)/1000.0 + "USD입니다.");// 소수점 제한 없는 코드
